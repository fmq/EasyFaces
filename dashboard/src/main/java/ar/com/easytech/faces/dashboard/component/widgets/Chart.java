...
@FacesComponent(Chart.COMPONENT_TYPE)
...
public class Chart extends BaseWidget implements ClientBehaviorHolder {
	
	public static final String COMPONENT_TYPE = "ar.com.easyfaces.ChartWidget";
	public static final String RENDERER_TYPE = "ar.com.easyfaces.ChartRenderer";
