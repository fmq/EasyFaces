...
@FacesComponent(PieChart.COMPONENT_TYPE)
...
public class PieChart extends BaseWidget implements ClientBehaviorHolder {
	
	public static final String COMPONENT_TYPE = "ar.com.easyfaces.PieChartWidget";
	public static final String RENDERER_TYPE = "ar.com.easyfaces.PieChartRenderer";
